...
class Tauler
{
    public:
        ...
        void Treure_Carta(int col, int quant=-1);
		...
		void NumCartesColumna(int columna, int &obertes, int &tancades);
    ...
    private:
		...
		int a_quantitat, a_col_rest, a_pila_rest; //num de cartes tretes/que es restauraran a en cas de que laccio no es pugui realitzar. Columna a la que es restauraràn.
